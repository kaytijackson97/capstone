            ...
            <div className="row">
                <div className="col">
                    <div className="card text-white mt-3 mb-3 text-center" style={{backgroundColor: 'rgba(255, 255, 255, 0.5)', backdropFilter: 'blur(3px)', paddingTop: '20px'}}>
                        ...
                        <p className="card-body" style={{color: 'rgba(133, 166, 141, 1)', fontFamily: 'Century Gothic'}}>A social media platform specifically for the plant community</p>
                        <div className="text-center">
                        <img src={WelcomeImage} alt="welcome" style={{justifyContent: 'center', alignItems: 'center', marginBottom: '50px',width: '100%', height: '11rem', objectFit: 'contain'}}/>
                        </div>
                    </div>
                </div>
            </div>
